...
import org.amnay.reporting.ExtentManager;
import org.amnay.reporting.ExtentTestManager;
...
//    }
    ...
    public void selectRadioButton(List<WebElement> elements, String attribute, String value ){
        for (WebElement radioButton: elements) {
            if (radioButton.getAttribute(attribute).equalsIgnoreCase(value)){
                radioButton.click();
            }
        }
    }
    ...
    public void waitForElementToBeAvailable(WebDriver driver1, WebElement element) {
        WebDriverWait wait = new WebDriverWait(driver1, Duration.ofSeconds(60));
        wait.until(ExpectedConditions.visibilityOf(element));
    }

    public void waitForElementToBeClickable(WebDriver driver1, WebElement element) {
        WebDriverWait wait = new WebDriverWait(driver1, Duration.ofSeconds(60));
